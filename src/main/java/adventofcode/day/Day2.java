...
public class Day2 {
    private static final InputHelper INPUT = new InputHelper("157\t564\t120\t495\t194\t520\t510\t618\t244\t443\t471\t473\t612\t149\t506\t138\n" +
    ...
    private static void starOne() {
        final List<List<Integer>> theList = INPUT.toListOfList("\\t", "\\n");
